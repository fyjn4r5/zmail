        ...
        <>
          <div className="flex items-center">
            ...
            <div className="hidden sm:flex items-center">
              ...
              <button
                onClick={copyToClipboard}
                className="flex items-center gap-1.5 px-3 py-1.5 text-sm rounded-md bg-muted hover:bg-primary/20 hover:text-primary transition-all duration-200"
                aria-label={t('common.copy')}
                title={t('common.copy')}
              >
                <i className="fas fa-copy text-sm"></i>
              ...
              <button
                ...
                className={`w-8 h-8 flex items-center justify-center rounded-md bg-muted hover:bg-primary/20 hover:text-primary transition-all duration-200 hover:scale-110 ${refreshButtonClass || ''}`}
                disabled={isActionLoading}
